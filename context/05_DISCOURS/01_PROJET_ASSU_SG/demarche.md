# 1. Contact DIR-RSE ASSU via TEAMS
## 1.1 Le texte
Bonjour X,

Je souhaiterais solliciter 30 minutes de votre temps pour échanger autour d'un modèle de développement territorial que je construis depuis plusieurs années.

Depuis près de dix ans, je développe une approche structurée autour de la gouvernance, de l'entrepreneuriat, de la formation et de l'économie sociale.

Ce travail a aujourd'hui donné naissance à une organisation structurée, un plan décennal, plusieurs programmes opérationnels et un référentiel territorial.

En étudiant récemment la stratégie RSE de Société Générale, j'ai été frappé par les convergences entre les ambitions du Groupe et celles de cette démarche.

J'aimerais beaucoup recueillir votre regard sur ces convergences et échanger avec vous sur les perspectives qu'elles pourraient ouvrir entre Société Générale et NZUANE.

Si cette démarche retient votre attention, je m'adapterai volontiers à vos disponibilités.
...
- conduit des expérimentations sociales, 
- créé des activités économiques et des emplois,
- développé des partenariats
avec un objectif constant : comprendre, sur le terrain, ce qui permet réellement à un territoire de se développer durablement.

De cette expérience est né un modèle intégré de développement territorial, dont NZUANE constitue aujourd'hui le cadre de mise en œuvre.

Notre objectif n'est pas de porter des projets isolés, mais de structurer un écosystème où chaque programme répond à un besoin identifié et renforce les autres.
Les projets que nous développons (ROMBONE, BIDI, FEMMESADV, etc.) ne sont pas des projets indépendants ; ils constituent les différentes composantes d'un même système.
...
- d'un référentiel territorial ;
- de plusieurs programmes structurants ;
- d'une stratégie documentaire ;
...
ROMBONE, BIDI, FEMMESADV ou EBWA ne sont pas des projets indépendants.
Ils sont les différentes briques d'un même modèle de développement territorial.